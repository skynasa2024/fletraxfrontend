...
export default function MileageReport() {
  ...
  const columns = useMemo<ColumnDef<MileageData>[]>(
    () => [
      {
        accessorKey: 'id',
        header: intl.formatMessage({ id: 'REPORTS.MILEAGE_REPORT.COLUMN.IDENTIFY_NUMBER' }),
        enableSorting: true
      },
      {
        accessorKey: 'plate',
        header: intl.formatMessage({ id: 'REPORTS.MILEAGE_REPORT.COLUMN.PLATE' }),
        enableSorting: true,
        cell: ({ row }) => <CarPlate />
      },
      {
        accessorKey: 'date',
        header: intl.formatMessage({ id: 'REPORTS.MILEAGE_REPORT.COLUMN.DATE' }),
        enableSorting: true
      },
      {
        accessorKey: 'daily',
        header: intl.formatMessage({ id: 'REPORTS.MILEAGE_REPORT.COLUMN.Daily' }),
        enableSorting: true
      },
      {
        accessorKey: 'weekly',
        header: intl.formatMessage({ id: 'REPORTS.MILEAGE_REPORT.COLUMN.WEEKLY' }),
        enableSorting: true
      },
      {
        accessorKey: 'monthly',
        header: intl.formatMessage({ id: 'REPORTS.MILEAGE_REPORT.COLUMN.MONTHLY' }),
        enableSorting: true
      },
      {
        accessorKey: 'yearly',
        header: intl.formatMessage({ id: 'REPORTS.MILEAGE_REPORT.COLUMN.YEARLY' }),
        enableSorting: true
      },
      {
        accessorKey: 'total',
        header: intl.formatMessage({ id: 'REPORTS.MILEAGE_REPORT.COLUMN.TOTAL' }),
        enableSorting: true
      },
      {
        header: intl.formatMessage({ id: 'REPORTS.MILEAGE_REPORT.COLUMN.ACTION' })
      }
    ],
    [intl]
  );
