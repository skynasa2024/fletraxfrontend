...
export const MaintenanceVehicleDropdownSearch = ({ initialSearch }: MaintenanceVehicleDropdownSearchProps) => {
  ...
  useEffect(() => {
    if (initialSearch) {
      setPrivateSearch(initialSearch.plate);
      setSelectedVehicleId(initialSearch.id);
    }
  }, [initialSearch]);
