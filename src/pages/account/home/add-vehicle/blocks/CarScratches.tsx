                ...
                <div className="space-y-4">
                  <div className="flex gap-4">
                    ...
                    <div className="w-2/3">
                      ...
                      <p className="mt-1 text-sm text-gray-500">Unlimited files, 5GB total limit</p>
                    </div>
                  </div>
